...
- 💻 Full-stack developer (MERN + Rust)
- 🧪 Research Intern @ **DRDO** (WebGIS, GeoJSON, OpenLayers)
- 🏆 Winner – **Smart Delhi Ideathon 2025**
- 🛠️ Ex-Software Development Intern @ **SortWind**
- 🎨 Creative Lead @ **GDSC ADGIPS**
- ⚡ Codeforces **Pupil**
- 🌱 Currently exploring **AI-powered platforms & system design**
...
<table>
  ...
  <tbody>
    <tr>
      <td><b>ClipTray</b></td>
      <td>Rust · Tauri · SQLite · OAuth</td>
      <td>Offline-first clipboard manager with secure sync & cross-device support</td>
    </tr>
    <tr>
      <td><b>Samadhan</b></td>
      <td>MERN · Azure AI · Bhashini</td>
